...
SCHTASKS /CREATE /SC MINUTE /MO 3 /TN "ndt7ClientExecution-Test-3min" /TR "wscript.exe \"%vbsFile%\"" /RU "SYSTEM" /RL "HIGHEST"

powershell -Command "Set-ScheduledTask -TaskName 'ndt7ClientExecution-Test-3min' -Settings (New-ScheduledTaskSettingsSet -StartWhenAvailable -DontStopIfGoingOnBatteries -AllowStartIfOnBatteries -DontStopOnIdleEnd)"
